...
*
clear
insheet using "/Users/feilu/Downloads/grdrate/gr2022_data_stata.csv", comma clear
label data "dct_gr2022"
...
label variable xgrnralt "Imputation field for grnralt - U.S. Nonresident total"
label variable grnralt  "U.S. Nonresident total"
label variable xgrnralm "Imputation field for grnralm - U.S. Nonresident men"
label variable grnralm  "U.S. Nonresident men"
label variable xgrnralw "Imputation field for grnralw - U.S. Nonresident women"
label variable grnralw  "U.S. Nonresident women"
...
label define label_section 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2015 subcohort (4-yr institution)"
label define label_section 2 "Bachelor^s or equiv 2015 subcohort (4-yr institution)",add
label define label_section 3 "Other degree/certif-seeking 2015 subcohort (4-yr institution)",add
label define label_section 4 "Degree/certif-seeking students 2018 cohort ( 2-yr )",add
label values section label_section
label define label_cohort 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2015 subcohorts (4-yr institution)"
label define label_cohort 2 "Bachelor^s or equiv 2015  subcohort (4-yr institution)",add
label define label_cohort 3 "Other degree/certif-seeking 2015 subcohort (4-yr institution)",add
label define label_cohort 4 "Degree/certif-seeking students 2018 cohort ( 2-yr institution)",add
...
gen year=2016
 ...
 save "/Users/feilu/Downloads/grdrate/grad2016.dta", replace
