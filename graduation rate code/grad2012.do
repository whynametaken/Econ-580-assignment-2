...
*
insheet using "/Users/feilu/Downloads/grdrate/GR2018_Data_Stata/gr2018_data_stata.csv", comma clear
label data "dct_gr2018"
...
label define label_section 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2012 subcohort (4-yr institution)"
label define label_section 2 "Bachelor^s or equiv 2012 subcohort (4-yr institution)",add
label define label_section 3 "Other degree/certif-seeking 2012 subcohort (4-yr institution)",add
label define label_section 4 "Degree/certif-seeking students 2015 cohort ( 2-yr )",add
label values section label_section
label define label_cohort 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2012 subcohorts (4-yr institution)"
label define label_cohort 2 "Bachelor^s or equiv 2012  subcohort (4-yr institution)",add
label define label_cohort 3 "Other degree/certif-seeking 2012 subcohort (4-yr institution)",add
label define label_cohort 4 "Degree/certif-seeking students 2015 cohort ( 2-yr institution)",add
...
gen year=2012
 ...
 save "/Users/feilu/Downloads/grdrate/grad2012.dta", replace
