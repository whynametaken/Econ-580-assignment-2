...
*
insheet using "/Users/feilu/Downloads/grdrate/GR2020_Data_Stata/gr2020_data_stata.csv", comma clear
label data "dct_GR2020"
...
label define label_section 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2014 subcohort (4-yr institution)"
label define label_section 2 "Bachelor^s or equiv 2014 subcohort (4-yr institution)",add
label define label_section 3 "Other degree/certif-seeking 2014 subcohort (4-yr institution)",add
label define label_section 4 "Degree/certif-seeking students 2017 cohort ( 2-yr )",add
label values section label_section
label define label_cohort 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2014 subcohorts (4-yr institution)"
label define label_cohort 2 "Bachelor^s or equiv 2017  subcohort (4-yr institution)",add
label define label_cohort 3 "Other degree/certif-seeking 2017 subcohort (4-yr institution)",add
label define label_cohort 4 "Degree/certif-seeking students 2017 cohort ( 2-yr institution)",add
...
gen year=2014
 ...
 save "/Users/feilu/Downloads/grdrate/grad2014.dta", replace
