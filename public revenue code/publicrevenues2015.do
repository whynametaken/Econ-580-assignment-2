...
*
clear
insheet using "/Users/feilu/Downloads/revenue/F1415_F1A_Data_Stata/f1415_f1a_data_stata.csv", comma clear
...
label variable xf1m01 "Imputation field for f1m01 - Additional (or decreased) pension expense"
label variable f1m01    "Additional (or decreased) pension expense"
label variable xf1m02 "Imputation field for f1m02 - Additional pension liability (or asset)"
label variable f1m02    "Additional pension liability (or asset)"
...
gen year=2015
 ...
 save "/Users/feilu/Downloads/revenue/publicrevenues2015.dta", replace
