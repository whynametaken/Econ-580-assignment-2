...
*
clear
insheet using "/Users/feilu/Downloads/directory/hd2022_data_stata.csv", comma clear
label data "dct_hd2022"
...
label variable ueis     "Unique Entity Identifier (UEI) Numbers"
...
label variable c21basic "Carnegie Classification 2021: Basic"
label variable c21ipug  "Carnegie Classification 2021: Undergraduate Instructional Program"
label variable c21ipgrd "Carnegie Classification 2021: Graduate Instructional Program"
label variable c21ugprf "Carnegie Classification 2021: Undergraduate Profile"
label variable c21enprf "Carnegie Classification 2021: Enrollment Profile"
label variable c21szset "Carnegie Classification 2021: Size and Setting"
...
label variable cngdstcd "State and 116TH Congressional District ID"
...
*/
label define label_deathyr 2022 "2022"
...
label values c21basic label_c21basic
label define label_c21ipug 1 "Associate^s Colleges: High Transfer"
label define label_c21ipug 2 "Associate^s Colleges: Mixed Transfer/Career & Technical",add
label define label_c21ipug 3 "Associate^s Colleges: High Career & Technical",add
label define label_c21ipug 4 "Special Focus: Two-Year Institution",add
label define label_c21ipug 5 "Baccalaureate/Associates Colleges",add
label define label_c21ipug 6 "Arts & sciences focus, no graduate coexistence",add
label define label_c21ipug 7 "Arts & sciences focus, some graduate coexistence",add
label define label_c21ipug 8 "Arts & sciences focus, high graduate coexistence",add
label define label_c21ipug 9 "Arts & sciences plus professions, no graduate coexistence",add
label define label_c21ipug 10 "Arts & sciences plus professions, some graduate coexistence",add
label define label_c21ipug 11 "Arts & sciences plus professions, high graduate coexistence",add
label define label_c21ipug 12 "Balanced arts & sciences/professions, no graduate coexistence",add
label define label_c21ipug 13 "Balanced arts & sciences/professions, some graduate coexistence",add
label define label_c21ipug 14 "Balanced arts & sciences/professions, high graduate coexistence",add
label define label_c21ipug 15 "Professions plus arts & sciences, no graduate coexistence",add
label define label_c21ipug 16 "Professions plus arts & sciences, some graduate coexistence",add
label define label_c21ipug 17 "Professions plus arts & sciences, high graduate coexistence",add
label define label_c21ipug 18 "Professions focus, no graduate coexistence",add
label define label_c21ipug 19 "Professions focus, some graduate coexistence",add
label define label_c21ipug 20 "Professions focus, high graduate coexistence",add
label define label_c21ipug 0 "Not Classified (Exclusively Graduate Programs)",add
label define label_c21ipug -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c21ipug label_c21ipug
label define label_c21ipgrd 1 "Postbaccalaureate: Single program-Education"
label define label_c21ipgrd 2 "Postbaccalaureate: Single program-Business",add
label define label_c21ipgrd 3 "Postbaccalaureate: Single program-Other",add
label define label_c21ipgrd 4 "Postbaccalaureate: Comprehensive programs",add
label define label_c21ipgrd 5 "Postbaccalaureate: Arts & sciences-dominant",add
label define label_c21ipgrd 6 "Postbaccalaureate: Education-dominant, with Arts & Sciences",add
label define label_c21ipgrd 7 "Postbaccalaureate: Business-dominant, with Arts & Sciences",add
label define label_c21ipgrd 8 "Postbaccalaureate: Other-dominant, with Arts & Sciences",add
label define label_c21ipgrd 9 "Postbaccalaureate: Education-dominant, with other professional programs",add
label define label_c21ipgrd 10 "Postbaccalaureate: Business-dominant, with other professional programs",add
label define label_c21ipgrd 11 "Postbaccalaureate: Other-dominant, with other professional programs",add
label define label_c21ipgrd 12 "Research Doctoral: Single program-Education",add
label define label_c21ipgrd 13 "Research Doctoral: Single program-Other",add
label define label_c21ipgrd 14 "Research Doctoral: Comprehensive programs, with medical/veterinary school",add
label define label_c21ipgrd 15 "Research Doctoral: Comprehensive programs, no medical/veterinary school",add
label define label_c21ipgrd 16 "Research Doctoral: Humanities/social sciences-dominant",add
label define label_c21ipgrd 17 "Research Doctoral: STEM-dominant",add
label define label_c21ipgrd 18 "Research Doctoral: Professional-dominant",add
label define label_c21ipgrd 0 "Not classified (Exclusively Undergraduate)",add
label define label_c21ipgrd -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c21ipgrd label_c21ipgrd
label define label_c21ugprf 1 "Two-year, higher part-time"
label define label_c21ugprf 2 "Two-year, mixed part/full-time",add
label define label_c21ugprf 3 "Two-year, medium full-time",add
label define label_c21ugprf 4 "Two-year, higher full-time",add
label define label_c21ugprf 5 "Four-year, higher part-time",add
label define label_c21ugprf 6 "Four-year, medium full-time, inclusive, lower transfer-in",add
label define label_c21ugprf 7 "Four-year, medium full-time, inclusive, higher transfer-in",add
label define label_c21ugprf 8 "Four-year, medium full-time, selective, lower transfer-in",add
label define label_c21ugprf 9 "Four-year, medium full-time , selective, higher transfer-in",add
label define label_c21ugprf 10 "Four-year, full-time, inclusive, lower transfer-in",add
label define label_c21ugprf 11 "Four-year, full-time, inclusive, higher transfer-in",add
label define label_c21ugprf 12 "Four-year, full-time, selective, lower transfer-in",add
label define label_c21ugprf 13 "Four-year, full-time, selective, higher transfer-in",add
label define label_c21ugprf 14 "Four-year, full-time, more selective, lower transfer-in",add
label define label_c21ugprf 15 "Four-year, full-time, more selective, higher transfer-in",add
label define label_c21ugprf 0 "Not classified (Exclusively Graduate)",add
label define label_c21ugprf -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c21ugprf label_c21ugprf
label define label_c21enprf 1 "Exclusively undergraduate two-year"
label define label_c21enprf 2 "Exclusively undergraduate four-year",add
label define label_c21enprf 3 "Very high undergraduate",add
label define label_c21enprf 4 "High undergraduate",add
label define label_c21enprf 5 "Majority undergraduate",add
label define label_c21enprf 6 "Majority graduate",add
label define label_c21enprf 7 "Exclusively graduate",add
label define label_c21enprf -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c21enprf label_c21enprf
label define label_c21szset 1 "Two-year, very small"
label define label_c21szset 2 "Two-year, small",add
label define label_c21szset 3 "Two-year, medium",add
label define label_c21szset 4 "Two-year, large",add
label define label_c21szset 5 "Two-year, very large",add
label define label_c21szset 6 "Four-year, very small, primarily nonresidential",add
label define label_c21szset 7 "Four-year, very small, primarily residential",add
label define label_c21szset 8 "Four-year, very small, highly residential",add
label define label_c21szset 9 "Four-year, small, primarily nonresidential",add
label define label_c21szset 10 "Four-year, small, primarily residential",add
label define label_c21szset 11 "Four-year, small, highly residential",add
label define label_c21szset 12 "Four-year, medium, primarily nonresidential",add
label define label_c21szset 13 "Four-year, medium, primarily residential",add
label define label_c21szset 14 "Four-year, medium, highly residential",add
label define label_c21szset 15 "Four-year, large, primarily nonresidential",add
label define label_c21szset 16 "Four-year, large, primarily residential",add
label define label_c21szset 17 "Four-year, large, highly residential",add
...
label values c21szset label_c21szset
...
label define label_f1syscod 200235 "Bryant & Stratton College",add
...
label define label_f1syscod 200410 "Allied Health Programs FL, LLC",add
...
label define label_f1syscod 200787 "Kansas City University",add
...
label define label_f1syscod 201500 "Touro University System",add
...
label define label_f1syscod 201620 "ECMC Education Inc.",add
...
label define label_f1syscod 300555 "Branford Academy of Hair & Cosmetology",add
label define label_f1syscod 300570 "ZOVIO",add
...
label define label_f1syscod 300840 "Perdoceo Education Corporation",add
...
label define label_f1syscod 301555 "South University - Member LLC",add
...
label define label_f1syscod 302380 "Hussian College Inc.",add
...
label define label_f1syscod 303610 "Paul Mitchell Advanced Education",add
...
label define label_f1syscod 304765 "United Group Services.",add
...
label define label_cbsa 37940 "Peru, IN",add
...
label define label_cbsa 41980 "San Juan-Bayamón-Caguas, PR",add
...
label define label_cbsa 46020 "Truckee-Grass Valley, CA",add
...
label define label_csa 490 "San Juan-Bayamón, PR",add
...
label define label_countycd 6057 "Nevada County, CA",add
...
label define label_countycd 9110 "Capitol Planning Region, CT",add
label define label_countycd 9120 "Greater Bridgeport Planning Region, CT",add
label define label_countycd 9130 "Lower Connecticut River Valley Planning Region, CT",add
label define label_countycd 9140 "Naugatuck Valley Planning Region, CT",add
label define label_countycd 9150 "Northeastern Connecticut Planning Region, CT",add
label define label_countycd 9160 "Northwest Hills Planning Region, CT",add
label define label_countycd 9170 "South Central Connecticut Planning Region, CT",add
label define label_countycd 9180 "Southeastern Connecticut Planning Region, CT",add
label define label_countycd 9190 "Western Connecticut Planning Region, CT",add
...
label define label_countycd 16067 "Minidoka County, ID",add
...
label define label_countycd 18027 "Daviess County, IN",add
...
label define label_countycd 18103 "Miami County, IN",add
...
label define label_countycd 26097 "Mackinac County, MI",add
...
label define label_countycd 29043 "Christian County, MO",add
...
label define label_countycd 36073 "Orleans County, NY",add
...
label define label_countycd 42123 "Warren County, PA",add
...
label define label_countycd 48021 "Bastrop County, TX",add
...
label define label_countycd 54005 "Boone County, WV",add
...
label define label_dfrcgid 90 "Doctoral Universities: Highest Research Activity, Public/1 of 3"
label define label_dfrcgid 91 "Doctoral Universities: Highest Research Activity, Public/2 of 3",add
label define label_dfrcgid 92 "Doctoral Universities: Highest Research Activity, Public/3 of 3",add
label define label_dfrcgid 93 "Doctoral Universities: Highest Research Activity, Private not-for-profit",add
label define label_dfrcgid 94 "Doctoral Universities: Higher Research Activity, Public/1 of 3",add
label define label_dfrcgid 95 "Doctoral Universities: Higher Research Activity, Public/2 of 3",add
label define label_dfrcgid 96 "Doctoral Universities: Higher Research Activity, Public/3 of 3",add
label define label_dfrcgid 97 "Doctoral Universities: Higher Research Activity, Private not-for-profit",add
label define label_dfrcgid 98 "Doctoral/Professional Universities, Public",add
label define label_dfrcgid 99 "Doctoral/Professional Universities, Private not-for-profit/1 of 4",add
label define label_dfrcgid 100 "Doctoral/Professional Universities, Private not-for-profit/2 of 4",add
label define label_dfrcgid 101 "Doctoral/Professional Universities, Private not-for-profit/3 of 4",add
label define label_dfrcgid 102 "Doctoral/Professional Universities, Private not-for-profit/4 of 4",add
label define label_dfrcgid 103 "Doctoral/Professional Universities, Private for-profit",add
label define label_dfrcgid 104 "Masters Colleges and Universities (larger programs), Public/1 of 5",add
label define label_dfrcgid 105 "Masters Colleges and Universities (larger programs), Public/2 of 5",add
label define label_dfrcgid 106 "Masters Colleges and Universities (larger programs), Public/3 of 5",add
label define label_dfrcgid 107 "Masters Colleges and Universities (larger programs), Public/4 of 5",add
label define label_dfrcgid 108 "Masters Colleges and Universities (larger programs), Public/5 of 5",add
label define label_dfrcgid 109 "Masters Colleges and Universities (larger programs), Private not-for-profit/1 of 5",add
label define label_dfrcgid 110 "Masters Colleges and Universities (larger programs), Private not-for-profit/2 of 5",add
label define label_dfrcgid 111 "Masters Colleges and Universities (larger programs), Private not-for-profit/3 of 5",add
label define label_dfrcgid 112 "Masters Colleges and Universities (larger programs), Private not-for-profit/4 of 5",add
label define label_dfrcgid 113 "Masters Colleges and Universities (larger programs), Private not-for-profit/5 of 5",add
label define label_dfrcgid 114 "Masters Colleges and Universities (larger programs), Private for-profit",add
label define label_dfrcgid 115 "Masters Colleges and Universities (medium programs), Public/1 of 2",add
label define label_dfrcgid 116 "Masters Colleges and Universities (medium programs), Public/2 of 2",add
label define label_dfrcgid 117 "Masters Colleges and Universities (medium programs), Private not-for-profit/1 of 4",add
label define label_dfrcgid 118 "Masters Colleges and Universities (medium programs), Private not-for-profit/2 of 4",add
label define label_dfrcgid 119 "Masters Colleges and Universities (medium programs), Private not-for-profit/3 of 4",add
label define label_dfrcgid 120 "Masters Colleges and Universities (medium programs), Private not-for-profit/4 of 4",add
label define label_dfrcgid 121 "Masters Colleges and Universities (medium programs), Private for-profit",add
label define label_dfrcgid 122 "Masters Colleges and Universities (smaller programs), Public",add
label define label_dfrcgid 123 "Masters Colleges and Universities (smaller programs), Private not-for-profit/1 of 3",add
label define label_dfrcgid 124 "Masters Colleges and Universities (smaller programs), Private not-for-profit/2 of 3",add
label define label_dfrcgid 125 "Masters Colleges and Universities (smaller programs), Private not-for-profit/3 of 3",add
label define label_dfrcgid 202 "Degree-granting four-year, private not-for-profit with no Carnegie classification highest degree - Master^s",add
label define label_dfrcgid 126 "Masters Colleges and Universities (smaller programs), baccalaureate Colleges, or associate^s Colleges, Private for-profit",add
label define label_dfrcgid 127 "Baccalaureate Colleges--Arts & Sciences, Public",add
label define label_dfrcgid 128 "Baccalaureate Colleges--Arts & Sciences, Private not-for-profit/1 of 6",add
label define label_dfrcgid 129 "Baccalaureate Colleges--Arts & Sciences, Private not-for-profit/2 of 6",add
label define label_dfrcgid 130 "Baccalaureate Colleges--Arts & Sciences, Private not-for-profit/3 of 6",add
label define label_dfrcgid 131 "Baccalaureate Colleges--Arts & Sciences, Private not-for-profit/4 of 6",add
label define label_dfrcgid 132 "Baccalaureate Colleges--Arts & Sciences, Private not-for-profit/5 of 6",add
label define label_dfrcgid 133 "Baccalaureate Colleges--Arts & Sciences, Private not-for-profit/6 of 6",add
label define label_dfrcgid 134 "Baccalaureate Colleges--Arts & Sciences, Public/1 of 2",add
label define label_dfrcgid 135 "Baccalaureate Colleges--Arts & Sciences, Public/2 of 2",add
label define label_dfrcgid 58 "Public, degree-granting four-year highest level- bachelors",add
label define label_dfrcgid 136 "Baccalaureate Colleges--Diverse Fields, Private not-for-profit/1 of 6",add
label define label_dfrcgid 137 "Baccalaureate Colleges--Diverse Fields, Private not-for-profit/2 of 6",add
label define label_dfrcgid 138 "Baccalaureate Colleges--Diverse Fields, Private not-for-profit/3 of 6",add
label define label_dfrcgid 139 "Baccalaureate Colleges--Diverse Fields, Private not-for-profit/4 of 6",add
label define label_dfrcgid 140 "Baccalaureate Colleges--Diverse Fields, Private not-for-profit/5 of 6",add
label define label_dfrcgid 141 "Baccalaureate Colleges--Diverse Fields, Private not-for-profit/6 of 6",add
label define label_dfrcgid 142 "Baccalaureate/Associates Colleges, private not-for-profit",add
label define label_dfrcgid 143 "Faith-Related Institutions, highest level- bachelors, undergraduate degrees/certificates offered/1 of 2",add
label define label_dfrcgid 144 "Faith-Related Institutions, highest level- bachelors, undergraduate degrees/certificates offered/2 of 2",add
label define label_dfrcgid 145 "Faith-Related Institutions, highest level- postbacc, undergraduate degrees/certificates offered",add
label define label_dfrcgid 146 "Faith-Related Institutions highest level- postbacc, undergraduate degrees/certificates not offered",add
label define label_dfrcgid 147 "Faith-Related Institutions, highest level- Phd, undergraduate degrees/certificates offered",add
label define label_dfrcgid 148 "Faith-Related Institutions, highest level- Phd, undergraduate degrees/certificates not offered/1 of 2",add
label define label_dfrcgid 149 "Faith-Related Institutions, highest level- Phd, undergraduate degrees/certificates not offered/2 of 2",add
label define label_dfrcgid 151 "Medical schools and medical centers, Public",add
label define label_dfrcgid 152 "Medical schools and medical centers, Private not-for-profit",add
label define label_dfrcgid 153 "Other health professions schools, Private not-for-profit/1 of 3",add
label define label_dfrcgid 154 "Other health professions schools, Private not-for-profit/2 of 3",add
label define label_dfrcgid 155 "Other health professions schools, Private not-for-profit/3 of 3",add
label define label_dfrcgid 157 "Other health professions schools, Private for-profit/1 of 2",add
label define label_dfrcgid 158 "Other health professions schools, Private for-profit/2 of 2",add
label define label_dfrcgid 160 "Schools of research, Public",add
label define label_dfrcgid 161 "Schools of research, Private not-for-profit",add
label define label_dfrcgid 162 "Schools of engineering and other tech related fields",add
label define label_dfrcgid 163 "Schools of business and management, Private not-for-profit",add
label define label_dfrcgid 164 "Schools of business and management, Private for-profit",add
label define label_dfrcgid 166 "Schools of art, music, and design, Private for-profit",add
label define label_dfrcgid 168 "Schools of art, music, and design, public, private not-for-profit",add
label define label_dfrcgid 169 "Schools of law",add
label define label_dfrcgid 171 "Other special-focus four year institutions",add
label define label_dfrcgid 199 "Baccalaureate Colleges--Diverse Fields, Private for-profit",add
label define label_dfrcgid 200 "Degree-granting four-year, public or private for-profit with no Carnegie classification highest degree - Bachelor^s",add
label define label_dfrcgid 201 "Degree-granting four-year, private not-for-profit with no Carnegie classification highest degree - Bachelor^s",add
label define label_dfrcgid 150 "Degree-granting four-year primarily associate^s, Faith-Related Institutions",add
label define label_dfrcgid 156 "Degree-granting four-year primarily associate^s, Health professions schools, private for-profit",add
label define label_dfrcgid 159 "Degree-granting four-year primarily associate^s, Health professions schools, public or private not-for-profit",add
label define label_dfrcgid 165 "Degree-granting four-year primarily associate^s, Schools of art, music, and design, private for-profit",add
label define label_dfrcgid 167 "Degree-granting four-year primarily associate^s, Schools of art, music, and design, public or private not-for-profit",add
label define label_dfrcgid 170 "Degree-granting four-year primarily associate^s, Other special-focus institutions",add
label define label_dfrcgid 186 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, Public/1 of 4",add
label define label_dfrcgid 187 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, Public/2 of 4",add
label define label_dfrcgid 188 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, Public/3 of 4",add
label define label_dfrcgid 189 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, Public/4 of 4",add
label define label_dfrcgid 190 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, Private not-for-profit",add
label define label_dfrcgid 191 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, Private for-profit",add
label define label_dfrcgid 192 "Degree-granting four-year, primarily associate^s,  Mixed Baccalaureate/Associate^s, Public/1 of 2",add
label define label_dfrcgid 193 "Degree-granting four-year, primarily associate^s,  Mixed Baccalaureate/Associate^s, Public/2 of 2",add
label define label_dfrcgid 194 "Degree-granting four-year, primarily associate^s,  Mixed Baccalaureate/Associate^s, Private not-for-profit",add
label define label_dfrcgid 195 "Degree-granting four-year, primarily associate^s,  Mixed Baccalaureate/Associate^s, Private for-profit",add
label define label_dfrcgid 196 "Degree-granting four year, primarilty associate^s, with no Carnegie classifcation, private not-for-profit",add
label define label_dfrcgid 197 "Degree-granting four year, primarilty associate^s, with no Carnegie classifcation, private for-profit",add
label define label_dfrcgid 59 "Associate^s Colleges: High Transfer-High Traditional, Public/1 of 3",add
label define label_dfrcgid 60 "Associate^s Colleges: High Transfer-High Traditional, Public/2 of 3",add
label define label_dfrcgid 61 "Associate^s Colleges: High Transfer-High Traditional, Public/3 of 3",add
label define label_dfrcgid 62 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, Public/1 of 3",add
label define label_dfrcgid 63 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, Public/2 of 3",add
label define label_dfrcgid 64 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, Public/3 of 3",add
label define label_dfrcgid 65 "Associate^s Colleges: High Transfer-High Nontraditional, Public/1 of 3",add
label define label_dfrcgid 66 "Associate^s Colleges: High Transfer-High Nontraditional, Public/2 of 3",add
label define label_dfrcgid 67 "Associate^s Colleges: High Transfer-High Nontraditional, Public/3 of 3",add
label define label_dfrcgid 68 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, Public/1 of 3",add
label define label_dfrcgid 69 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, Public/2 of 3",add
label define label_dfrcgid 70 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, Public/3 of 3",add
label define label_dfrcgid 71 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, Public/1 of 3",add
label define label_dfrcgid 72 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, Public/2 of 3",add
label define label_dfrcgid 73 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, Public/3 of 3",add
label define label_dfrcgid 74 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, Public/1 of 3",add
label define label_dfrcgid 75 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, Public/2 of 3",add
label define label_dfrcgid 76 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, Public/3 of 3",add
label define label_dfrcgid 77 "Associate^s Colleges: High Career & Technical-High Traditional, Public/1 of 2",add
label define label_dfrcgid 78 "Associate^s Colleges: High Career & Technical-High Traditional, Public/2 of 2",add
label define label_dfrcgid 79 "Associate^s Colleges: High Career & Technical-High Traditional, Private for-profit",add
label define label_dfrcgid 80 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, Public/1 of 3",add
label define label_dfrcgid 81 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, Public/2 of 3",add
label define label_dfrcgid 82 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, Public/3 of 3",add
label define label_dfrcgid 83 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, Private for-profit",add
label define label_dfrcgid 84 "Associate^s Colleges: High Career & Technical-High Nontraditional, Public/1 of 2",add
label define label_dfrcgid 85 "Associate^s Colleges: High Career & Technical-High Nontraditional, Public/2 of 2",add
label define label_dfrcgid 86 "Associate^s Colleges: High Career & Technical-High Nontraditional, Private for-profit",add
label define label_dfrcgid 87 "Associate colleges: High/Mixed Transfer, Private not-for-profit",add
label define label_dfrcgid 88 "Associate colleges: High/Mixed Transfer, Private for-profit",add
label define label_dfrcgid 89 "Associate colleges: High Career & Technical, Private not-for-profit",add
label define label_dfrcgid 173 "Special Focus Two Year or Other Associate^s College, Public",add
label define label_dfrcgid 174 "Special Focus Two Year: Health, Private not-for-profit",add
label define label_dfrcgid 175 "Special Focus Two Year: Health, Private for-profit/1 of 5",add
label define label_dfrcgid 176 "Special Focus Two Year: Health, Private for-profit/2 of 5",add
label define label_dfrcgid 177 "Special Focus Two Year: Health, Private for-profit/3 of 5",add
label define label_dfrcgid 178 "Special Focus Two Year: Health, Private for-profit/4 of 5",add
label define label_dfrcgid 179 "Special Focus Two Year: Health, Private for-profit/5 of 5",add
label define label_dfrcgid 180 "Special Focus Two Year: Technical, Private not-for-profit",add
label define label_dfrcgid 181 "Special Focus Two Year: Technical, Private for-profit",add
label define label_dfrcgid 182 "Special Focus Two Year: Art & Design, Private not-for-profit",add
label define label_dfrcgid 183 "Special Focus Two Year: Art & Design, Private for-profit",add
label define label_dfrcgid 216 "Other Associate^s Colleges, Private not-for-profit",add
label define label_dfrcgid 184 "Special Focus Two Year: Other, Private not-for-profit",add
label define label_dfrcgid 217 "Other Associate^s Colleges, Private for-profit/1 of 2",add
label define label_dfrcgid 218 "Other Associate^s Colleges, Private for-profit/2 of 2",add
label define label_dfrcgid 185 "Special Focus Two Year: Other, Private for-profit",add
label define label_dfrcgid 172 "Tribal Colleges",add
label define label_dfrcgid 206 "U.S. Military Academies",add
label define label_dfrcgid 1 "Nondegree-granting, public, academic year reporter",add
label define label_dfrcgid 2 "Nondegree-granting, public, largest program - cosm",add
label define label_dfrcgid 3 "Nondegree-granting, public, largest program - health/1 of 6",add
label define label_dfrcgid 4 "Nondegree-granting, public, largest program - health/2 of 6",add
label define label_dfrcgid 5 "Nondegree-granting, public, largest program - health/3 of 6",add
label define label_dfrcgid 6 "Nondegree-granting, public, largest program - health/4 of 6",add
label define label_dfrcgid 7 "Nondegree-granting, public, largest program - health/5 of 6",add
label define label_dfrcgid 8 "Nondegree-granting, public, largest program - health/6 of 6",add
label define label_dfrcgid 207 "Nondegree-granting, public, largest program - engineering and engineering technologies",add
label define label_dfrcgid 208 "Nondegree-granting, public  largest program - manufacturing, construction, repair, and transportation/1 of 2",add
label define label_dfrcgid 209 "Nondegree-granting, public  largest program - manufacturing, construction, repair, and transportation/2 of 2",add
label define label_dfrcgid 9 "Nondegree-granting, public, largest program - other",add
label define label_dfrcgid 10 "Nondegree-granting, private not-for-profit, academic year reporter",add
label define label_dfrcgid 11 "Nondegree-granting, private not-for-profit, largest program - cosmetology",add
label define label_dfrcgid 12 "Nondegree-granting, private not-for-profit, largest program - health",add
label define label_dfrcgid 210 "Nondegree-granting, private not-for-profit, largest program - manufacturing, construction, repair, and transportation",add
label define label_dfrcgid 13 "Nondegree-granting, private not-for-profit, largest program - other",add
label define label_dfrcgid 14 "Nondegree-granting, for-profit, academic year reporter",add
label define label_dfrcgid 15 "Nondegree-granting, private for-profit,  largest program - cosmetology/1 of 34",add
label define label_dfrcgid 16 "Nondegree-granting, private for-profit,  largest program - cosmetology/2 of 34",add
label define label_dfrcgid 17 "Nondegree-granting, private for-profit,  largest program - cosmetology/3 of 34",add
label define label_dfrcgid 18 "Nondegree-granting, private for-profit,  largest program - cosmetology/4 of 34",add
label define label_dfrcgid 19 "Nondegree-granting, private for-profit,  largest program - cosmetology/5 of 34",add
label define label_dfrcgid 20 "Nondegree-granting, private for-profit,  largest program - cosmetology/6 of 34",add
label define label_dfrcgid 21 "Nondegree-granting, private for-profit,  largest program - cosmetology/7 of 34",add
label define label_dfrcgid 22 "Nondegree-granting, private for-profit,  largest program - cosmetology/8 of 34",add
label define label_dfrcgid 23 "Nondegree-granting, private for-profit,  largest program - cosmetology/9 of 34",add
label define label_dfrcgid 24 "Nondegree-granting, private for-profit,  largest program - cosmetology/10 of 34",add
label define label_dfrcgid 25 "Nondegree-granting, private for-profit,  largest program - cosmetology/11 of 34",add
label define label_dfrcgid 26 "Nondegree-granting, private for-profit,  largest program - cosmetology/12 of 34",add
label define label_dfrcgid 27 "Nondegree-granting, private for-profit,  largest program - cosmetology/13 of 34",add
label define label_dfrcgid 28 "Nondegree-granting, private for-profit,  largest program - cosmetology/14 of 34",add
label define label_dfrcgid 29 "Nondegree-granting, private for-profit,  largest program - cosmetology/15 of 34",add
label define label_dfrcgid 30 "Nondegree-granting, private for-profit,  largest program - cosmetology/16 of 34",add
label define label_dfrcgid 31 "Nondegree-granting, private for-profit,  largest program - cosmetology/17 of 34",add
label define label_dfrcgid 32 "Nondegree-granting, private for-profit,  largest program - cosmetology/18 of 34",add
label define label_dfrcgid 33 "Nondegree-granting, private for-profit,  largest program - cosmetology/19 of 34",add
label define label_dfrcgid 34 "Nondegree-granting, private for-profit,  largest program - cosmetology/20 of 34",add
label define label_dfrcgid 35 "Nondegree-granting, private for-profit,  largest program - cosmetology/21 of 34",add
label define label_dfrcgid 36 "Nondegree-granting, private for-profit,  largest program - cosmetology/22 of 34",add
label define label_dfrcgid 37 "Nondegree-granting, private for-profit,  largest program - cosmetology/23 of 34",add
label define label_dfrcgid 38 "Nondegree-granting, private for-profit,  largest program - cosmetology/24 of 34",add
label define label_dfrcgid 39 "Nondegree-granting, private for-profit,  largest program - cosmetology/25 of 34",add
label define label_dfrcgid 40 "Nondegree-granting, private for-profit,  largest program - cosmetology/26 of 34",add
label define label_dfrcgid 41 "Nondegree-granting, private for-profit,  largest program - cosmetology/27 of 34",add
label define label_dfrcgid 42 "Nondegree-granting, private for-profit,  largest program - cosmetology/28 of 34",add
label define label_dfrcgid 43 "Nondegree-granting, private for-profit,  largest program - cosmetology/29 of 34",add
label define label_dfrcgid 44 "Nondegree-granting, private for-profit,  largest program - cosmetology/30 of 34",add
label define label_dfrcgid 45 "Nondegree-granting, private for-profit,  largest program - cosmetology/31 of 34",add
label define label_dfrcgid 46 "Nondegree-granting, private for-profit,  largest program - cosmetology/32 of 34",add
label define label_dfrcgid 47 "Nondegree-granting, private for-profit,  largest program - cosmetology/33 of 34",add
label define label_dfrcgid 48 "Nondegree-granting, private for-profit,  largest program - cosmetology/34 of 34",add
label define label_dfrcgid 49 "Nondegree-granting, private for-profit,  largest program - health/1 of 8",add
label define label_dfrcgid 50 "Nondegree-granting, private for-profit,  largest program - health/2 of 8",add
label define label_dfrcgid 51 "Nondegree-granting, private for-profit,  largest program - health/3 of 8",add
label define label_dfrcgid 52 "Nondegree-granting, private for-profit,  largest program - health/4 of 8",add
label define label_dfrcgid 53 "Nondegree-granting, private for-profit,  largest program - health/5 of 8",add
label define label_dfrcgid 54 "Nondegree-granting, private for-profit,  largest program - health/6 of 8",add
label define label_dfrcgid 55 "Nondegree-granting, private for-profit,  largest program - health/7 of 8",add
label define label_dfrcgid 56 "Nondegree-granting, private for-profit,  largest program - health/8 of 8",add
label define label_dfrcgid 57 "Nondegree-granting, private for-profit, largest program - other",add
label define label_dfrcgid 211 "Nondegree-granting, private for-profit, largest program - communications and communication technologies",add
label define label_dfrcgid 212 "Nondegree-granting, private for-profit, largest program - engineering and engineering technologies",add
label define label_dfrcgid 213 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/1 of 3",add
label define label_dfrcgid 214 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/2 of 3",add
label define label_dfrcgid 215 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/3 of 3",add
label define label_dfrcgid 219 "Degree-granting less-than four-year, public in Puerto Rico",add
label define label_dfrcgid 220 "Degree-granting four-year, public in Puerto Rico",add
label define label_dfrcgid 221 "Degree-granting, private not-for-profit in Puerto Rico/1 of 2",add
label define label_dfrcgid 222 "Degree-granting, private not-for-profit in Puerto Rico/2 of 2",add
label define label_dfrcgid 223 "Degree-granting, private for-profit in Puerto Rico",add
label define label_dfrcgid 224 "Nondegree-granting private for-profit or not-for-profit in Puerto Rico",add
label define label_dfrcgid 198 "Jurisdictions other than Puerto Rico or Other Associate^s Colleges",add
label define label_dfrcgid 203 "Non-Title IV, degree-granting",add
label define label_dfrcgid 204 "Non-Title IV, nondegree-granting, the largest program-cosmetology",add
label define label_dfrcgid 205 "Non-Title IV, nondegree-granting, the largest program-health",add
label define label_dfrcgid -1 "Not reported",add
...
gen year=2022
sort unitid
save "/Users/feilu/Downloads/directory/directory2022.dta", replace
