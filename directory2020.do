...
*
clear
insheet using "/Users/feilu/Downloads/directory/hd2020_data_stata.csv", comma clear
label data "dct_hd2020"
...
label define label_deathyr 2020 "2019"
...
label define label_f1syscod 200505 "Cyrus The Great International Online University",add
...
label define label_dfrcgid 93 "Doctoral Universities: Highest Research Activity, public/1 of 3"
label define label_dfrcgid 94 "Doctoral Universities: Highest Research Activity, public/2 of 3",add
label define label_dfrcgid 95 "Doctoral Universities: Highest Research Activity, public/3 of 3",add
label define label_dfrcgid 96 "Doctoral Universities: Highest Research Activity, private not-for-profit",add
label define label_dfrcgid 97 "Doctoral Universities: Higher Research Activity, public/1 of 3",add
label define label_dfrcgid 98 "Doctoral Universities: Higher Research Activity, public/2 of 3",add
label define label_dfrcgid 99 "Doctoral Universities: Higher Research Activity, public/3 of 3",add
label define label_dfrcgid 100 "Doctoral Universities: Higher Research Activity, private not-for-profit",add
label define label_dfrcgid 101 "Doctoral/Professional Universities, public",add
label define label_dfrcgid 102 "Doctoral/Professional Universities, private not-for-profit/1 of 3",add
label define label_dfrcgid 103 "Doctoral/Professional Universities, private not-for-profit/2 of 3",add
label define label_dfrcgid 104 "Doctoral/Professional Universities, private not-for-profit/3 of 3",add
...
label define label_dfrcgid 125 "Masters Colleges and Universities (smaller programs), private not-for-profit/1 of 2",add
label define label_dfrcgid 126 "Masters Colleges and Universities (smaller programs), private not-for-profit/2 of 2",add
label define label_dfrcgid 127 "Masters Colleges and Universities (smaller programs), private for-profit",add
label define label_dfrcgid 128 "Baccalaureate Colleges--Arts & Sciences, public",add
label define label_dfrcgid 129 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/1 of 6",add
label define label_dfrcgid 130 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/2 of 6",add
label define label_dfrcgid 131 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/3 of 6",add
label define label_dfrcgid 132 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/4 of 6",add
label define label_dfrcgid 133 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/5 of 6",add
label define label_dfrcgid 134 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/6 of 6",add
label define label_dfrcgid 135 "Baccalaureate Colleges--Diverse Fields, public/1 of 2",add
label define label_dfrcgid 136 "Baccalaureate Colleges--Diverse Fields, public/2 of 2",add
label define label_dfrcgid 137 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/1 of 6",add
label define label_dfrcgid 138 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/2 of 6",add
label define label_dfrcgid 139 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/3 of 6",add
label define label_dfrcgid 140 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/4 of 6",add
label define label_dfrcgid 141 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/5 of 6",add
label define label_dfrcgid 142 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/6 of 6",add
label define label_dfrcgid 143 "Baccalaureate/Associates Colleges, private not-for-profit",add
label define label_dfrcgid 144 "Theological seminaries/Bible colleges/faith-related institutions, highest level-bachelor^s degree/1 of 2",add
label define label_dfrcgid 145 "Theological seminaries/Bible colleges/faith-related institutions, highest level-bachelor^s degree/2 of 2",add
label define label_dfrcgid 146 "Theological seminaries/Bible colleges/faith-related institutions, highest level-postbaccalaureate, undergraduate degrees/certificates offered",add
label define label_dfrcgid 147 "Theological seminaries/Bible colleges/faith-related institutions, highest level-postbaccalaureate, undergraduate degrees/certificates not offered",add
label define label_dfrcgid 148 "Theological seminaries/Bible colleges/faith-related institutions, highest level-doctor^s, undergraduate degrees /certificates offered",add
label define label_dfrcgid 149 "Theological seminaries/Bible colleges/faith-related institutions, highest level-doctor^s, undergraduate degrees /certificates not offered/1 of 2",add
label define label_dfrcgid 150 "Theological seminaries/Bible colleges/faith-related institutions, highest level-doctor^s, undergraduate degrees /certificates not offered/2 of 2",add
label define label_dfrcgid 152 "Medical schools and medical centers, public",add
label define label_dfrcgid 153 "Medical schools and medical centers, private not-for-profit",add
label define label_dfrcgid 154 "Other health professions schools, public",add
...
label define label_dfrcgid 162 "Schools of engineering",add
label define label_dfrcgid 164 "Other technology-related schools",add
label define label_dfrcgid 165 "Schools of business and management, private not-for-profit",add
label define label_dfrcgid 167 "Schools of business and management, private for-profit",add
label define label_dfrcgid 169 "Schools of art, music, and design, private for-profit",add
label define label_dfrcgid 170 "Schools of art, music, and design, Public or private not-for-profit",add
label define label_dfrcgid 171 "Schools of art, music, and design, Public or private not-for-profit",add
label define label_dfrcgid 172 "Schools of law",add
label define label_dfrcgid 174 "Other special-focus four year institutions",add
label define label_dfrcgid 201 "Baccalaureate Colleges--Diverse Fields, private for-profit",add
label define label_dfrcgid 202 "Degree-granting four-year, private for-profit with no Carnegie classification highest degree - Bachelor^s",add
...
label define label_dfrcgid 61 "Degree-granting four-year, highest degree - Bachelor^s, public",add
label define label_dfrcgid 200 "Degree-granting four-year with no Carnegie classification, highest degree-Doctor^s or Master^s, private for-profit",add
label define label_dfrcgid 151 "Degree-granting four-year primarily associate^s, Theological seminaries/Bible college/faith-related institutions",add
...
label define label_dfrcgid 163 "Degree-granting four-year primarily associate^s, Technology-related schools",add
label define label_dfrcgid 166 "Degree-granting four-year primarily associate^s, Schools of business and management, private for-profit",add
label define label_dfrcgid 168 "Degree-granting four-year primarily associate^s, Schools of art, music, and design, private for-profit",add
label define label_dfrcgid 173 "Degree-granting four-year primarily associate^s, Other special-focus institutions",add
label define label_dfrcgid 189 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, public/1 of 4",add
label define label_dfrcgid 190 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, public/2 of 4",add
label define label_dfrcgid 191 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, public/3 of 4",add
label define label_dfrcgid 192 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, public/4 of 4",add
label define label_dfrcgid 193 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, private not-for-profit",add
label define label_dfrcgid 194 "Degree-granting four-year, primarily associate^s, Associate^s Dominant, private for-profit",add
label define label_dfrcgid 195 "Degree-granting four-year, primarily associate^s, †Mixed Baccalaureate/Associate^s, public",add
...
label define label_dfrcgid 62 "Associate^s Colleges: High Transfer-High Traditional, public/1 of 4",add
label define label_dfrcgid 63 "Associate^s Colleges: High Transfer-High Traditional, public/2 of 4",add
label define label_dfrcgid 64 "Associate^s Colleges: High Transfer-High Traditional, public/3 of 4",add
label define label_dfrcgid 65 "Associate^s Colleges: High Transfer-High Traditional, public/4 of 4",add
label define label_dfrcgid 66 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/1 of 4",add
label define label_dfrcgid 67 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/2 of 4",add
label define label_dfrcgid 68 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/3 of 4",add
label define label_dfrcgid 69 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/4 of 4",add
label define label_dfrcgid 70 "Associate^s Colleges: High Transfer-High Nontraditional, public/1 of 2",add
label define label_dfrcgid 71 "Associate^s Colleges: High Transfer-High Nontraditional, public/2 of 2",add
label define label_dfrcgid 72 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, public/1 of 4",add
label define label_dfrcgid 73 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, public/2 of 4",add
label define label_dfrcgid 74 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, public/3 of 4",add
label define label_dfrcgid 75 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, public/4 of 4",add
label define label_dfrcgid 76 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, public/1 of 3",add
label define label_dfrcgid 77 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, public/2 of 3",add
label define label_dfrcgid 78 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, public/3 of 3",add
label define label_dfrcgid 79 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, public/1 of 3",add
label define label_dfrcgid 80 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, public/2 of 3",add
label define label_dfrcgid 81 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, public/3 of 3",add
label define label_dfrcgid 82 "Associate^s Colleges: High Career & Technical-High Traditional, public/1 of 2",add
label define label_dfrcgid 83 "Associate^s Colleges: High Career & Technical-High Traditional, public/2 of 2",add
label define label_dfrcgid 84 "Associate^s Colleges: High Career & Technical-High Traditional, private for-profit",add
label define label_dfrcgid 85 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, public/1 of 2",add
label define label_dfrcgid 86 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, public/2 of 2",add
label define label_dfrcgid 87 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, private for-profit",add
label define label_dfrcgid 88 "Associate^s Colleges: High Career & Technical-High Nontraditional, public/1 of 2",add
label define label_dfrcgid 89 "Associate^s Colleges: High Career & Technical-High Nontraditional, public/2 of 2",add
label define label_dfrcgid 90 "Associate^s Colleges: High Career & Technical-High Nontraditional, private for-profit",add
label define label_dfrcgid 91 "Associate colleges: High/Mixed Transfer, private not-for-profit",add
label define label_dfrcgid 92 "Associate colleges: High Career & Technical, private not-for-profit",add
label define label_dfrcgid 176 "Special Focus Two Year: any program, public",add
label define label_dfrcgid 177 "Special Focus Two Year: Health, private not-for-profit",add
label define label_dfrcgid 178 "Special Focus Two Year: Health, private for-profit/1 of 5",add
label define label_dfrcgid 179 "Special Focus Two Year: Health, private for-profit/2 of 5",add
label define label_dfrcgid 180 "Special Focus Two Year: Health, private for-profit/3 of 5",add
label define label_dfrcgid 181 "Special Focus Two Year: Health, private for-profit/4 of 5",add
label define label_dfrcgid 182 "Special Focus Two Year: Health, private for-profit/5 of 5",add
label define label_dfrcgid 183 "Special Focus Two Year: Technical, private not-for-profit",add
label define label_dfrcgid 184 "Special Focus Two Year: Technical, private for-profit",add
label define label_dfrcgid 185 "Special Focus Two Year: Art & Design, private not-for-profit",add
label define label_dfrcgid 186 "Special Focus Two Year: Art & Design, private for-profit",add
label define label_dfrcgid 220 "Other Associate^s Colleges, public",add
label define label_dfrcgid 187 "Special Focus Two Year: Other, private not-for-profit",add
label define label_dfrcgid 221 "Other Associate^s Colleges, private not-for-profit",add
label define label_dfrcgid 188 "Special Focus Two Year: Other, private for-profit",add
label define label_dfrcgid 222 "Other Associate^s Colleges, private for-profit/1 of 3",add
label define label_dfrcgid 223 "Other Associate^s Colleges, private for-profit/2 of 3",add
label define label_dfrcgid 224 "Other Associate^s Colleges, private for-profit/3 of 3",add
label define label_dfrcgid 175 "Tribal Colleges",add
...
label define label_dfrcgid 2 "Nondegree-granting, public, largest program - cosmetology",add
label define label_dfrcgid 3 "Nondegree-granting, public, largest program - health/1 of 7",add
label define label_dfrcgid 4 "Nondegree-granting, public, largest program - health/2 of 7",add
label define label_dfrcgid 5 "Nondegree-granting, public, largest program - health/3 of 7",add
label define label_dfrcgid 6 "Nondegree-granting, public, largest program - health/4 of 7",add
label define label_dfrcgid 7 "Nondegree-granting, public, largest program - health/5 of 7",add
label define label_dfrcgid 8 "Nondegree-granting, public, largest program - health/6 of 7",add
label define label_dfrcgid 9 "Nondegree-granting, public, largest program - health/7 of 7",add
label define label_dfrcgid 210 "Nondegree-granting, public, largest program - engineering and engineering technologies",add
label define label_dfrcgid 211 "Nondegree-granting, public  largest program - manufacturing, construction, repair, and transportation",add
label define label_dfrcgid 10 "Nondegree-granting, public, largest program - other",add
label define label_dfrcgid 11 "Nondegree-granting, private not-for-profit, academic year reporter",add
label define label_dfrcgid 12 "Nondegree-granting, private not-for-profit, largest program - cosmetology",add
label define label_dfrcgid 13 "Nondegree-granting, private not-for-profit, largest program - health",add
label define label_dfrcgid 14 "Nondegree-granting, private not-for-profit, largest program - other",add
label define label_dfrcgid 212 "Nondegree-granting, private not-for-profit, largest program - manufacturing, construction, repair, and transportation",add
label define label_dfrcgid 15 "Nondegree-granting, for-profit, academic year reporter",add
label define label_dfrcgid 16 "Nondegree-granting, private for-profit,  largest program - cosmetology/1 of 35",add
label define label_dfrcgid 17 "Nondegree-granting, private for-profit,  largest program - cosmetology/2 of 35",add
label define label_dfrcgid 18 "Nondegree-granting, private for-profit,  largest program - cosmetology/3 of 35",add
label define label_dfrcgid 19 "Nondegree-granting, private for-profit,  largest program - cosmetology/4 of 35",add
label define label_dfrcgid 20 "Nondegree-granting, private for-profit,  largest program - cosmetology/5 of 35",add
label define label_dfrcgid 21 "Nondegree-granting, private for-profit,  largest program - cosmetology/6 of 35",add
label define label_dfrcgid 22 "Nondegree-granting, private for-profit,  largest program - cosmetology/7 of 35",add
label define label_dfrcgid 23 "Nondegree-granting, private for-profit,  largest program - cosmetology/8 of 35",add
label define label_dfrcgid 24 "Nondegree-granting, private for-profit,  largest program - cosmetology/9 of 35",add
label define label_dfrcgid 25 "Nondegree-granting, private for-profit,  largest program - cosmetology/10 of 35",add
label define label_dfrcgid 26 "Nondegree-granting, private for-profit,  largest program - cosmetology/11 of 35",add
label define label_dfrcgid 27 "Nondegree-granting, private for-profit,  largest program - cosmetology/12 of 35",add
label define label_dfrcgid 28 "Nondegree-granting, private for-profit,  largest program - cosmetology/13 of 35",add
label define label_dfrcgid 29 "Nondegree-granting, private for-profit,  largest program - cosmetology/14 of 35",add
label define label_dfrcgid 30 "Nondegree-granting, private for-profit,  largest program - cosmetology/15 of 35",add
label define label_dfrcgid 31 "Nondegree-granting, private for-profit,  largest program - cosmetology/16 of 35",add
label define label_dfrcgid 32 "Nondegree-granting, private for-profit,  largest program - cosmetology/17 of 35",add
label define label_dfrcgid 33 "Nondegree-granting, private for-profit, largest program - cosmetology/18 of 35",add
label define label_dfrcgid 34 "Nondegree-granting, private for-profit, largest program - cosmetology/19 of 35",add
label define label_dfrcgid 35 "Nondegree-granting, private for-profit, largest program - cosmetology/20 of 35",add
label define label_dfrcgid 36 "Nondegree-granting, private for-profit, largest program - cosmetology/21 of 35",add
label define label_dfrcgid 37 "Nondegree-granting, private for-profit, largest program - cosmetology/22 of 35",add
label define label_dfrcgid 38 "Nondegree-granting, private for-profit, largest program - cosmetology/23 of 35",add
label define label_dfrcgid 39 "Nondegree-granting, private for-profit, largest program - cosmetology/24 of 35",add
label define label_dfrcgid 40 "Nondegree-granting, private for-profit, largest program - cosmetology/25 of 35",add
label define label_dfrcgid 41 "Nondegree-granting, private for-profit, largest program - cosmetology/26 of 35",add
label define label_dfrcgid 42 "Nondegree-granting, private for-profit, largest program - cosmetology/27 of 35",add
label define label_dfrcgid 43 "Nondegree-granting, private for-profit, largest program - cosmetology/28 of 35",add
label define label_dfrcgid 44 "Nondegree-granting, private for-profit, largest program - cosmetology/29 of 35",add
label define label_dfrcgid 45 "Nondegree-granting, private for-profit, largest program - cosmetology/30 of 35",add
label define label_dfrcgid 46 "Nondegree-granting, private for-profit, largest program - cosmetology/31 of 35",add
label define label_dfrcgid 47 "Nondegree-granting, private for-profit, largest program - cosmetology/32 of 35",add
label define label_dfrcgid 48 "Nondegree-granting, private for-profit, largest program - cosmetology/33 of 35",add
label define label_dfrcgid 49 "Nondegree-granting, private for-profit, largest program - cosmetology/34 of 35",add
label define label_dfrcgid 50 "Nondegree-granting, private for-profit, largest program - cosmetology/35 of 35",add
label define label_dfrcgid 51 "Nondegree-granting, private for-profit, largest program - health/1 of 9",add
label define label_dfrcgid 52 "Nondegree-granting, private for-profit, largest program - health/2 of 9",add
label define label_dfrcgid 53 "Nondegree-granting, private for-profit, largest program - health/3 of 9",add
label define label_dfrcgid 54 "Nondegree-granting, private for-profit, largest program - health/4 of 9",add
label define label_dfrcgid 55 "Nondegree-granting, private for-profit, largest program - health/5 of 9",add
label define label_dfrcgid 56 "Nondegree-granting, private for-profit, largest program - health/6 of 9",add
label define label_dfrcgid 57 "Nondegree-granting, private for-profit, largest program - health/7 of 9",add
label define label_dfrcgid 58 "Nondegree-granting, private for-profit, largest program - health/8 of 9",add
label define label_dfrcgid 59 "Nondegree-granting, private for-profit, largest program - health/9 of 9",add
label define label_dfrcgid 60 "Nondegree-granting, private for-profit, largest program - other",add
label define label_dfrcgid 213 "Nondegree-granting, private for-profit, largest program - communications and communication technologies",add
label define label_dfrcgid 214 "Nondegree-granting, private for-profit, largest program - engineering and engineering technologies",add
label define label_dfrcgid 215 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/1 of 3",add
label define label_dfrcgid 216 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/2 of 3",add
label define label_dfrcgid 217 "Nondegree-granting, private for-profi,t largest program - manufacturing, construction, repair, and transportation/3 of 3",add
label define label_dfrcgid 226 "Degree-granting four year, public in Puerto Rico",add
label define label_dfrcgid 227 "Degree-granting, private not-for-profit in Puerto Rico/1 of 2",add
label define label_dfrcgid 228 "Degree-granting, private not-for-profit in Puerto Rico/2 of 2",add
label define label_dfrcgid 229 "Degree-granting, private for-profit in Puerto Rico",add
label define label_dfrcgid 230 "Nondegree-granting private for-profit or not-for-profit in Puerto Rico/1 of 2",add
label define label_dfrcgid 231 "Nondegree-granting private for-profit or not-for-profit in Puerto Rico/2 of 2",add
label define label_dfrcgid 218 "Degree-granting 4-year in jurisdictions other than Puerto Rico",add
label define label_dfrcgid 219 "Less-than 4-year public in Puerto Rico or other jurisdictions",add
...
gen year=2020
sort unitid
save "/Users/feilu/Downloads/directory/directory2020.dta", replace
